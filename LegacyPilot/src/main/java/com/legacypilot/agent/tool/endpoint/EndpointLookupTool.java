 ...
 */
@Component
public class EndpointLookupTool {
    private static final Logger log = LoggerFactory.getLogger(EndpointLookupTool.class);

    private final CodeAnalysisResultStore codeAnalysisResultStore;

    public EndpointLookupTool(CodeAnalysisResultStore codeAnalysisResultStore) {
