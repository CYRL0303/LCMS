package com.legacypilot.lcms.client;

import com.legacypilot.lcms.dto.CodeKnowledgeGraphSnapshotResponse;
import com.legacypilot.lcms.dto.CodeKnowledgeIndexRequest;
 ...
 * the repository/onboarding flow directly beyond the DTO contract.
 */
@Service
